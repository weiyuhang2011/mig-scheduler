...
type MigratorSpec struct {
	...
	// Foo is an example field of Migrator. Edit migrator_types.go to remove/update
...
const (
	Init      MigratorPhase = "Init"
	Preparing MigratorPhase = "Preparing"
	Dumping   MigratorPhase = "Dumping"
	Completed MigratorPhase = "Completed"
	Failed    MigratorPhase = "Failed"
)
...
type MigratorStatus struct {
	...
	// Important: Run "make" to regenerate code after modifying this file
	Phase        MigratorPhase `json:"phase"`
	ContainersID []string      `json:"containers_id"`
}
